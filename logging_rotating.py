...
from shared_utils import setup_logger, MAX_LOG_BYTES, LOG_BACKUP_COUNT
...
def setup_rotating_logger(
    ...
    """
    Delegates to shared_utils.setup_logger with rotation enabled.
    """
    return setup_logger(bot_name, log_file, level=level, max_bytes=max_bytes, backup_count=backup_count, rotating=True)
